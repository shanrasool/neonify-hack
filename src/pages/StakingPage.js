...
const StakingPage = () => {
        ...
        if (availableForUnstake > 0n) {
          ...
          setStakedMessage(
            `You have ${ethers.formatEther(
              availableForUnstake
            )} ETH available for unstaking in the Neonify Pool.`
          );
        } else {
  ...
  const handleStake = async () => {
    ...
    try {
      ...
      setStakedMessage(`You staked ${amount} ETH in the Neonify Pool.`);
      setErrorMessage("");
    ...
    <div style={{ position: "relative", textAlign: "center" }}>
      ...
      <div>
        <h1 className="titlestake">
          Earn from every token deployed through Neonify
        </h1>
      ...
      <div className="staking-container">
        ...
        <h2 className="Neonify-title">Neonify ETH Pool</h2>
        {!isConnected && (
